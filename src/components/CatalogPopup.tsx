  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-md p-0 bg-white rounded-3xl border-0 shadow-2xl overflow-hidden">
        <div className="relative bg-gradient-to-br from-primary-400 to-primary-500">
          ...
          <div className="absolute top-6 right-6 z-20">
            <button
              ...
              className="w-12 h-12 bg-white/90 backdrop-blur-xl rounded-full flex items-center justify-center hover:bg-white transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-110 border border-white/30 group"
            >
              <X size={20} className="text-primary-500 group-hover:text-primary-600 transition-colors duration-300" />
            </button>
          </div>
          ...
          <div className="p-8 text-center relative z-10">
            ...
            <div className="mb-8">
              <div className="flex items-center justify-center mb-4">
                <div className="w-16 h-16 bg-white/90 backdrop-blur-sm rounded-2xl flex items-center justify-center shadow-2xl animate-scale-in border border-white/30">
            ...
            <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-6 mb-6 shadow-2xl border border-white/60 animate-fade-in delay-200">
              <div className="flex items-center justify-center space-x-2 mb-3">
                <Zap className="text-primary-500" size={18} />
                <p className="text-lg font-bold text-primary-600">
                  Acesso <span className="text-primary-500">7x</span>
                </p>
                <Zap className="text-primary-500" size={18} />
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <div 
                    className="w-full h-36 rounded-2xl overflow-hidden relative shadow-2xl border border-gray-100"
                    style={{
                  ...
                  <div className="absolute top-4 right-4">
                    <div className="bg-primary-500/90 backdrop-blur-sm text-white text-xs px-3 py-1.5 rounded-full font-bold shadow-xl flex items-center space-x-1 border border-white/30">
                      <Star size={12} />
                      <span>VIP</span>
                    </div>
                  </div>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="bg-white/90 backdrop-blur-sm rounded-full p-4 border border-white/60">
            ...
            {/* Enhanced CTA button */}
            <Button 
              className="w-full bg-white/90 hover:bg-white text-primary-600 hover:text-primary-700 font-bold py-4 rounded-2xl text-lg shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 border border-white/60"
