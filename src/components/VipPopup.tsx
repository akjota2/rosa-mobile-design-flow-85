  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-md p-0 bg-white rounded-3xl border-0 shadow-2xl overflow-hidden">
        <div className="relative bg-gradient-to-br from-primary-50 via-white to-pink-50">
          {/* Background decorative elements */}
          <div className="absolute top-0 left-0 w-24 h-24 bg-gradient-to-br from-primary-200/30 to-pink-200/20 rounded-full blur-xl animate-pulse"></div>
          <div className="absolute bottom-0 right-0 w-20 h-20 bg-gradient-to-tl from-primary-300/20 to-pink-200/10 rounded-full blur-xl animate-pulse delay-1000"></div>
          ...
          <div className="p-8 text-center relative z-10">
            ...
            <div className="bg-gradient-to-r from-primary-500 to-pink-500 text-white rounded-2xl p-4 mb-6 shadow-lg">
